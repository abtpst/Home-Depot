...
from preproc import Attribute_Features, Text_Proc_Features, Distance_Metric_Features, Similarity_Features, Final_Features
...
if __name__ == '__main__':
    ...
    Final_Features.generate_final_features()
